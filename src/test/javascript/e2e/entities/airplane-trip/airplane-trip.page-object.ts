...
export class AirplaneTripComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-airplane-trip div table .btn-danger'));
    title = element.all(by.css('jhi-airplane-trip div h2#page-heading span')).first();
...
export class AirplaneTripUpdatePage {
    pageTitle = element(by.id('jhi-airplane-trip-heading'));
